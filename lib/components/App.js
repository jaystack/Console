...
let _default = (_dec = (0, _reactRedux.connect)(state => ({ options: (0, _selectors.getOptions)(state) }), { updateOptions: _actions.updateOptions }), _dec(_class = class _default extends _react2.default.PureComponent {
  constructor(...args) {
    var _temp;
